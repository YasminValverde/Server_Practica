...
public class InMemoryUserRepositoryImpl implements UserRepository {
	...
	public InMemoryUserRepositoryImpl() {
		users.add(createUser("admin", "{noop}admin", "Admin", null, "ADMIN"));
		users.add(createUser("lisa", "{noop}lisa", "Lisa", "Brennan-Jobs", "USER"));
		users.add(createUser("paul", "{noop}paul", "Paul", "Allen", "USER"));
	}
