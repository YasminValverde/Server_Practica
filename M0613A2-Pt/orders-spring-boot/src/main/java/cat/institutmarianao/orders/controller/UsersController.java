...
public class UsersController {
    ...
    public Order setupOrder(Authentication authentication) {
        ...
        // Create a new order. If authentication is available, set the client.
        Order order = new Order();
        // 🔧 Arreglo: en tu copia aparecía "&amp;&amp;" (HTML escapado). Debe ser "&&".
    ...
    public String newOrderIncreaseItem(
    ...
    public String newOrderDecreaseItem(
            @SessionAttribute("order") Order order,
            /* REVIEW - Get the "reference" parameter */ @RequestParam("reference") Long reference) {
    ...
    public ModelAndView finishOrder(@SessionAttribute("order") Order order) {
        ...
        // ⚠️ Para evitar errores de Thymeleaf con lambdas en la vista, calculamos totales aquí:
        int totalQty = order.getItems().values().stream()
        ...
        // REVIEW - Return the finishOrder view name (con datos adicionales)
        ModelAndView mv = new ModelAndView("finishOrder");
